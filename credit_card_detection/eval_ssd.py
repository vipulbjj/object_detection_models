...
parser.add_argument("--dataset_type", default="voc", type=str,
                    help='Specify dataset type. Currently support voc, foot_images and open_images.')
parser.add_argument("--dataset", type=str, help="The root directory of the VOC dataset, Foot dataset or Open Images dataset.")
...
if __name__ == '__main__':
    ...
    if args.dataset_type == "voc":
        ...
        dataset = FootImagesDataset(args.dataset, dataset_type="test")
